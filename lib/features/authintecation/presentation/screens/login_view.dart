...
import 'package:lamha/features/authintecation/presentation/widgets/login_view_body.dart';
      ...
      child: BlocConsumer<AuthintecationCubit, AuthintecationState>(
        listener: (context, state) {
          if (state is AuthintecationLoaded) {
            ...
            // هنا يمكنك التوجيه للصفحة الرئيسية
            // مثال: GoRouter.of(context).go(Routes.home);
        ...
        builder: (context, state) {
          return LoginViewBody(isLoading: state is AuthintecationLoading);
        },
      ),
    );
  }
